...
set apollo_config_db_url="jdbc:mysql://101.42.0.166:3306/ApolloConfigDB?characterEncoding=utf8"
set apollo_config_db_username="root"
set apollo_config_db_password="zn123abcasd"

rem apollo portal db info
set apollo_portal_db_url="jdbc:mysql://101.42.0.166:3306/ApolloPortalDB?characterEncoding=utf8"
set apollo_portal_db_username="root"
set apollo_portal_db_password="zn123abcasd"

rem meta server url, different environments should have different meta server addresses
set dev_meta="http://101.42.0.166:8080"

...
apollo_config_db_url='jdbc:mysql://101.42.0.166:3306/ApolloConfigDB?characterEncoding=utf8'
apollo_config_db_username='root'
apollo_config_db_password='zn123abcasd'

# apollo portal db info
apollo_portal_db_url='jdbc:mysql://101.42.0.166:3306/ApolloPortalDB?characterEncoding=utf8'
apollo_portal_db_username='root'
apollo_portal_db_password='zn123abcasd'

# meta server url, different environments should have different meta server addresses
dev_meta=http://101.42.0.166:8080
